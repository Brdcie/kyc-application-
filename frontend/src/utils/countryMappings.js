...
export const getCountryLabel = (countryCode) => {
  ...
  return countryMappings[code] || countryCode;
};

// Fonction pour obtenir la liste complète des pays
export const getCountriesList = () => {
  return Object.entries(countryMappings).map(([code, label]) => ({
    code,
    label
  }));
};